...
def _infer_wiki_type(name: str, url: str = "") -> str:
    ...
    chinese_keywords = {
        # 物品
        "剑": ["剑", "劍"], "刀": ["刀"], "斧": ["斧"], "镐": ["鎬", "稿"], "铲": ["铲", "鏟"], "锄": ["锄", "鋤"],
        "弓": ["弓"], "箭": ["箭"], "盾": ["盾"], "头盔": ["头盔", "頭盔"], "胸甲": ["胸甲"],
        "护腿": ["护腿", "護腿"], "靴子": ["靴子"], "钻石": ["钻石", "鑽石"], "铁": ["铁", "鐵"],
        "金": ["金"], "铜": ["铜", "銅"], "绿宝石": ["绿宝石", "綠寶石", "祖母绿", "祖母綠"],
        "下界合金": ["下界合金", "獄髓"], "鞘翅": ["鞘翅"],
        # 方块
        "方块": ["方块", "方塊"], "石头": ["石头", "石頭"], "泥土": ["泥土"], "沙子": ["沙子", "沙"],
        "圆石": ["圆石", "圓石", "鵝卵石"], "木板": ["木板"], "矿石": ["矿石", "礦石"],
        "原木": ["原木"], "树叶": ["树叶", "樹葉", "叶子", "葉子"], "玻璃": ["玻璃"],
        "冰": ["冰"], "雪": ["雪"], "草": ["草"], "花": ["花"], "蘑菇": ["蘑菇", "菇"],
        # 实体
        "僵尸": ["僵尸", "殭屍"], "骷髅": ["骷髅", "骷髏"], "苦力怕": ["苦力怕"], "末影人": ["末影人", "终界使者"],
        "猪": ["猪", "豬"], "牛": ["牛"], "羊": ["羊"], "鸡": ["鸡", "雞"], "蜘蛛": ["蜘蛛"],
        "史莱姆": ["史莱姆", "史萊姆"], "烈焰人": ["烈焰人"], "凋灵": ["凋灵", "凋零"], "末影龙": ["末影龙", "終界龍"],
        "恶魂": ["恶魂", "惡魂"], "猪灵": ["猪灵", "豬布林"], "潜影贝": ["潜影贝", "潛影貝"],
        "卫道士": ["卫道士", "衛道士"], "唤魔者": ["唤魔者", "喚魔者", "喚魔師"],
        # 维度
        "下界": ["下界", "地獄", "奈落"], "末地": ["末地", "終界", "終末"], "主世界": ["主世界", "主维度"],
        "要塞": ["要塞", "堡壘", "要塞(終末)", "地牢"], "末地城": ["末地城", "終界城"],
        # 生物群系
        "森林": ["森林"], "沙漠": ["沙漠"], "针叶林": ["针叶林", "針葉林", "針葉林"],
        "热带雨林": ["热带雨林", "熱帶雨林", "叢林"], "沼泽": ["沼泽", "沼澤", "泥塘"],
        "海洋": ["海洋"], "河流": ["河流"], "高山": ["高山", "山脉", "山脈"], "平原": ["平原"],
        "蘑菇岛": ["蘑菇岛", "蘑菇島", "菇島"],
        # 机制
        "合成": ["合成", "工作台"], "附魔": ["附魔", "附魔台"], "酿造": ["酿造", "釀造"],
        "熔炉": ["熔炉", "熔爐", "高炉", "高爐", "烟熏", "煙熏", " smoker"],
        "铁砧": ["铁砧", "鐵砧", "砧"], "锻造台": ["锻造台", "鍛造台"], "砂轮": ["砂轮", "砂輪"],
    }

    # 展平关键词映射
    for simple, variants in chinese_keywords.items():
        for variant in variants:
            if variant in n:
                # 映射到标准类型
                if simple in ["剑", "刀", "斧", "镐", "铲", "锄", "弓", "箭", "盾", "头盔", "胸甲", "护腿", "靴子", "钻石", "铁", "金", "铜", "绿宝石", "下界合金", "鞘翅"]:
                    return "item"
                elif simple in ["方块", "石头", "泥土", "沙子", "圆石", "木板", "矿石", "原木", "树叶", "玻璃", "冰", "雪", "草", "花", "蘑菇"]:
                    return "block"
                elif simple in ["僵尸", "骷髅", "苦力怕", "末影人", "猪", "牛", "羊", "鸡", "蜘蛛", "史莱姆", "烈焰人", "凋灵", "末影龙", "恶魂", "猪灵", "潜影贝", "卫道士", "唤魔者"]:
                    return "entity"
                elif simple in ["下界", "末地", "主世界", "要塞", "末地城"]:
                    return "dimension"
                elif simple in ["森林", "沙漠", "针叶林", "热带雨林", "沼泽", "海洋", "河流", "高山", "平原", "蘑菇岛"]:
                    return "biome"
                elif simple in ["合成", "附魔", "酿造", "熔炉", "铁砧", "锻造台", "砂轮"]:
                    return "mechanic"
