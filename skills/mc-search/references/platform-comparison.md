...
| 英文名称 | ✅ 有 | ✅ 完整 | ✅ 完整 |
| 依赖关系 | ⚠️ 联动信息 | ✅ 前置准确 | ❌ 无 |
| 版本信息 | ✅ 支持版本列表 | ✅ 详细版本分组 | ❌ 无 |
| 截图数量 | ⚠️ 默认 6 张限制 | ⚠️ 默认 10 张限制 | ❌ 无 |
| 更新日志 | ⚠️ 有/无标记 | ✅ 最近 5 条 | ❌ 无 |
| 开发团队 | ✅ 详细分工 | ❌ 仅作者名 | ❌ 无 |
| 社区统计 | ✅ 评分/浏览量 | ✅ 下载/关注数 | ❌ 无 |
...
4. **截图数量控制**：
   - 默认不返回截图（节省带宽）
   - 使用全局选项 `--screenshots <num>` 调整数量
   - MC百科最多 6 张，Modrinth 最多 10 张
